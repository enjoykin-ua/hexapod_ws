...
| Block | Inhalt | Status |
|---|---|---|
| **A** Analyse & Optimierung | Torque-/Hitze-Tool (A1 ✅); A2–A4 pausiert; **A5 IMU-Balance = später** (echter Fix für Nicht-Tripod-Wackeln + Terrain) | 🟢 A1 / ⏸️ Rest |
...
7. **Optional/mittelfristig:** A5 IMU-Balance (ruhiges Nicht-Tripod-Laufen + Terrain/Leveling).

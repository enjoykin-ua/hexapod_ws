...
| B4 | **Body-Pose ohne Laufen + „Show"-Pose (Free-Leg)** | 🟡 Plan (2026-06-04) | Stütz auf 4 hinteren Beinen (2,3,4,5), 2 Vorderbeine (1,6) frei per Joystick (hoch/runter/seitwärts, max Range). 3 Phasen: Hinstellen→Show→Beenden. CoG-Marge via joint_load (nur 4 Stützbeine!). Plan: `B4_show_pose_plan.md`. Sim zuerst, dann HW. |
